Pod::Spec.new do |s|
  ...
  s.description = <<-DESC
    SimplePurchase exposes three static methods: `addObserverForProduct:block:`, `loadProduct:block:`
  ...
  s.source = { :git => "https://github.com/chendry/SimplePurchase.git", :tag => "0.0.2" }
  s.platform = :ios, '3.0'
